...
$lang['advancedhelp'] = 'Damit erhalten Sie Zugriff auf ALLE CMS-Dateien, nicht nur auf das uploads-Verzeichnis (falls erlaubt)';
...
$lang['eventhelp_OnFileUploaded'] = '<table>
	<thead>
		<tr>
			<th>Parameter</th>
			<th>Beschreibung</th>
	...
	<tbody>
		<tr>
			<th>file</th>
			<td>die komplette Spezifikation der hochgeladenen Datei</td>
		</tr>
		<tr>
			<th>thumb</th>
			<td>die komplette Spezifikation des generierten Vorschaubilds (falls &uuml;berhaupt generiert)</td>
		</tr>
	</tbody>
</table>';
$lang['file'] = 'Datei';
...
$lang['fileimagetype'] = 'Diese Aktion kann auf diesem Bildtypen nicht angewendet werden';
$lang['fileinfo'] = 'Dateiinformationen';
$lang['filename'] = 'Dateiname';
$lang['fileno'] = 'Dateinummer';
$lang['filenotfound'] = 'Datei nicht gefunden';
$lang['filenotimage'] = 'Die angegebene Datei ist kein Bild oder fehlerhaft';
...
$lang['fileowner'] = 'Dateieigent&uuml;mer';
...
$lang['group'] = 'Gruppe';
$lang['help_advancedmode'] = 'Der erweiterte Modus erlaubt es Benutzern, auf das gesamte Dateisystem des Redaktionssystems zuzugreifen. <strong>Vorsicht!</strong> Damit ist es auch m&ouml;glich, die bestehende Installation zu besch&auml;digen.';
$lang['help_create_thumbnails'] = 'Wenn aktiviert wird die Dateiverwaltung automatisch ein Vorschaubild f&uuml;r neu hochgeladene Bilder erstellen';
$lang['help_iconsize'] = 'Diese Option erlaubt die Angabe der Gr&ouml;&szlig;e der Piktogramme in der Dateiliste';
$lang['help_permissionstyle'] = 'Mit dieser Option kann man die Darstellungsform der Berechtigungen &auml;ndern, einerseits in eine etwas lesbare Form (rwx &rarr; &bdquo;read/write/execute&ldquo;) oder in oktaler Form (z. B. &bdquo;755&ldquo;).';
$lang['help_showhiddenfiles'] = 'Ist diese Option aktiviert, werden Dateien und Verzeichnisse, die mit einem Punkt oder Unterstrich beginnen und normalerweise versteckt sind, in der Liste angezeigt. CMS Made Simple &ndash; und andere Programme &ndash; speichern gelegentlich wichtige Informationen (z. B. Zwischenspeicherinformationen) in diesen Verzeichnissen/Dateien.<br/>
<em>Hinweis:</em> Diese Einstellung ist nur n&uuml;tzlich, wenn der erweiterte Modus aktiviert ist.';
$lang['help_showthumbnails'] = 'Wenn aktiviert, wird in der Dateiliste ein Vorschaubild angezeigt, sofern eines existiert. Wenn deaktiviert, wird das System versuchen, ein Piktogramm anzuzeigen, dass den Dateitypen repr&auml;sentiert';
...
$lang['help_postrotate'] = '<table>
	<caption>Optionen</caption>
	<tbody>
		<tr>
			<th>keine</th>
			<td>Nach einer Rotation wird nichts weiteres unternommen. Das rotierte Bild k&ouml;nnte gr&ouml;&szlig;er sein als das Originalbild.</td>
		</tr>
		<tr>
			<th>beschneiden</th>
			<td>Das rotierte Bild wird auf die Abmessungen des Originals zugeschnitten. Das kann dazu f&uuml;hren, dass Teile des Bilds abgeschnitten werden.</td>
		</tr>
		<tr>
			<th>skalieren</th>
			<td>Das rotierte Bild wird skaliert, dass es in die gr&ouml;&szlig;te Abmessung des Originalbilds passt. Das Ergebnis wird wahrscheinlich ein gr&ouml;&szlig;eres Bild als das Original, aber es wird nichts abgeschnitten.</td>
		</tr>
	</tbody>
</table>';
$lang['iconsize'] = 'Gr&ouml;&szlig;e der Piktogramme';
...
$lang['internalerror'] = 'Interner Fehler (das bedeutet, irgend etwas ergibt keinen Sinn &ndash; bitte melden Sie uns m&ouml;glichst genau, was Sie getan haben)';
...
$lang['invalidnewdir'] = 'Der Name des neuen Verzeichnisses darf keine Zeichen wie /, \ und &bdquo;..&ldquo; enthalten.';
$lang['itemstocopy'] = 'diese Elemente kopieren';
$lang['itemstomove'] = 'Diese Elemente verschieben';
$lang['kb'] = 'KB';
$lang['largeicons'] = 'Gro&szlig;';
$lang['mb'] = 'MB';
$lang['mimetype'] = 'MIME-Typ';
$lang['moddescription'] = 'Verwaltung von Dateien und Verzeichnissen im Upload-Verzeichnis von CMS Made Simple';
...
$lang['pie_image_natural_size'] = 'nat&uuml;rliche Bildgr&ouml;&szlig;e';
$lang['pie_lock_proportion'] = 'Proportionen beibehalten';
$lang['pie_resize'] = 'Skalieren';
$lang['pie_crop'] = 'Beschneiden';
$lang['pie_reset'] = 'Zur&uuml;cksetzen';
$lang['pie_close'] = 'Schlie&szlig;en';
$lang['pie_image_w'] = 'Bildbreite';
$lang['pie_image_h'] = 'Bildh&ouml;he';
$lang['pie_crop_x'] = 'x-Achse beschneiden';
$lang['pie_crop_y'] = 'y-Achse beschneiden';
$lang['pie_crop_w'] = 'Breite beschneiden';
$lang['pie_crop_h'] = 'H&ouml;he beschneiden';
$lang['pie_warn_action'] = 'Sind Sie sicher? Es gibt kein Strg/Cmd-Z hier.';
$lang['pie_warn_reset'] = 'Sind Sie sicher? Das wird Ihre derzeitigen &Auml;nderungen verwerfen';
$lang['postinstall'] = 'Das Dateiverwaltungsmodul wurde installiert';
...
$lang['postrotate'] = 'Aktion nach Bildrotation';
$lang['predefined'] = 'voreingestellte Winkel';
...
$lang['really_uninstall'] = 'Wollen Sie das Dateiverwaltungsmodul wirklich deinstallieren?';
...
$lang['renameerror'] = 'Fehler: Element konnte nicht umbenannt werden';
$lang['renamefailure'] = 'Das Umbenennen der Datei ist fehlgeschlagen';
$lang['renamesuccess'] = 'Die Datei wurde umbenannt';
$lang['resize'] = 'Skalieren';
$lang['resizecrop'] = 'Skalieren/Beschneiden';
$lang['return'] = 'Zur&uuml;ck';
$lang['rotate'] = 'Drehen';
$lang['rotateimage'] = 'Bild drehen';
$lang['rotate_neg180'] = '-180&deg;';
$lang['rotate_neg135'] = '-135&deg;';
$lang['rotate_neg90'] = '-90&deg;';
$lang['rotate_neg45'] = '-45&deg;';
$lang['rotate_neg30'] = '-30&deg;';
$lang['rotate_pos30'] = '30&deg;';
$lang['rotate_pos45'] = '45&deg;';
$lang['rotate_pos90'] = '90&deg;';
$lang['rotate_pos135'] = '135&deg;';
$lang['rotate_pos180'] = '180&deg;';
$lang['rwxstyle'] = 'rwx';
$lang['save'] = 'Speichern';
...
$lang['title_col_filedate'] = 'Diese Spalte zeigt das letzte &Auml;nderungsdatum der Datei';
$lang['title_col_fileperms'] = 'Diese Spalte zeigt die Dateiberechtigungen';
$lang['title_col_filesize'] = 'Diese Spalte zeigt die Dateigr&ouml;&szlig;e';
$lang['title_col_fileowner'] = 'Diese Spalte zeigt den Namen des Besitzers der Datei';
$lang['title_copy'] = 'Ausgew&auml;hlte Datei kopieren';
$lang['title_delete'] = 'Ausgew&auml;hlte Datei l&ouml;schen';
$lang['title_move'] = 'Ausgew&auml;hlte Datei in einen anderen Ordner verschieben';
$lang['title_newdir'] = 'Neues Verzeichnis erstellen';
$lang['title_rename'] = 'Ausgew&auml;hlte Datei oder Verzeichnis umbenennen';
$lang['title_resizecrop'] = 'Ausgew&auml;hltes Bild skalieren oder beschneiden';
$lang['title_rotate'] = 'Ausgew&auml;hltes Bild drehen';
$lang['title_tagall'] = 'Alle sichtbaren Dateien ausw&auml;hlen';
$lang['title_thumbnail'] = 'Vorschaubild von diesem Bild erzeugen';
$lang['title_unpack'] = 'Ausgew&auml;hltes Archiv entpacken';
$lang['title_view'] = 'Ausgew&auml;hltes Bild anzeigen';
$lang['title_view_newwindow'] = 'Ausgew&auml;hltes Bild in einem neuen Fenster anzeigen';
...
$lang['uninstalled'] = 'Das Dateiverwaltungsmodul wurde deinstalliert';
$lang['unknown'] = 'Unbekannt';
$lang['unknownfileaction'] = 'Interner Fehler: Unbekannte Dateiaktion';
$lang['unpack'] = 'Entpacken';
$lang['unpackafterupload'] = 'Nach dem Hochladen die Datei entpacken (nur tgz- und zip-Dateien)?';
$lang['unpackfail'] = 'wurde mit folgendem Fehler abgebrochen:';
$lang['unpacksuccess'] = 'wurde entpackt';
$lang['upgraded'] = 'Das Dateiverwaltungsmodul wurde auf Version %s aktualisiert';
