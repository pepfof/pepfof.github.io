<?php /* Smarty version Smarty-3.1-DEV, created on 2017-02-17 21:08:19
         compiled from "module_file_tpl:CMSContentManager;ajax_get_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1405358a76643547d98-87568732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1405358a76643547d98-87568732',
  'function' => 
  array (
    'do_content_row' => 
    array (
  ...
  'unifunc' => 'content_58a76643ec5768_60443370',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a76643ec5768_60443370')) {function content_58a76643ec5768_60443370($_smarty_tpl) {?><?php if (!is_callable('smarty_cms_function_cms_action_url')) include 'C:\\xampp\\htdocs\\CMSMS\\plugins\\function.cms_action_url.php';
if (!is_callable('smarty_function_admin_icon')) include 'C:\\xampp\\htdocs\\CMSMS\\admin/plugins\\function.admin_icon.php';
if (!is_callable('smarty_function_form_start')) include 'C:\\xampp\\htdocs\\CMSMS\\plugins\\function.form_start.php';
...
<?php echo smarty_function_form_start(array('action'=>'defaultadmin','id'=>'listform'),$_smarty_tpl);?>
  ...
  <div id="contentlist">
  <?php if (isset($_smarty_tpl->tpl_vars['content_list']->value)) {?>
    <?php if (!is_callable('smarty_function_admin_icon')) include 'C:\xampp\htdocs\CMSMS\admin/plugins\function.admin_icon.php';
if (!is_callable('smarty_function_repeat')) include 'C:\xampp\htdocs\CMSMS\plugins\function.repeat.php';
